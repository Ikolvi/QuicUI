  ...
  if (!native_library_paths.empty()) {
    ...
    if (is_patch) {
      ...
      if (leaked_elf == nullptr) {
        ...
        // This is required for iOS sandboxing - we can't mmap executable pages
        // in Library/Caches directory
        ...
        // safe for iOS sandboxing. It reads the ELF data from the provided buffer.
      ...
      // This fallthrough works because NativeLibrary below can't read
      // ELF from our .vmcode files
    }
  }

...
#define CACHED_VM_STUBS_LIST(V)                                                \
  ...
  /* QuicUI code push stubs - added at end to avoid offset shift */            \
  V(CodePtr, quicui_interpreter_entry_stub_,                                   \
    StubCode::QuicuiInterpreterEntry().ptr(), nullptr)                         \
  V(CodePtr, quicui_dispatch_stub_,                                            \
    StubCode::QuicuiDispatch().ptr(), nullptr)

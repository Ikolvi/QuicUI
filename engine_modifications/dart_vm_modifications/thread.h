...
#define CACHED_VM_STUBS_LIST(V)                                                \
  ...
  V(CodePtr, quicui_resume_interpreter_stub_,                                  \
    StubCode::QuicuiResumeInterpreter().ptr(), nullptr)                        \
  V(CodePtr, quicui_dispatch_to_patch_stub_,                                   \
    StubCode::QuicuiDispatchToPatch().ptr(), nullptr)

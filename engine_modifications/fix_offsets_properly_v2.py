...
4. Handles BOTH regular (Thread_xxx) and AOT prefixed (AOT_Thread_xxx) entries
"""
...
def process_file(input_path, output_path):
    ...
    while i < len(lines):
        ...
        # Check if this is the insertion point for either Thread_ or AOT_Thread_
        insertion_match = False
        for prefix in prefixes:
            search_str = f'{prefix}call_native_through_safepoint_stub_offset'
            if search_str in line and '=' in line:
                ...
                if base_offset is not None:
                    ...
                    # Insert QuicUI entries with appropriate prefix
...
"""
        ...
        shift_match = False
        for prefix in prefixes:
            if f'{prefix}' in line and '_offset' in line and '=' in line:

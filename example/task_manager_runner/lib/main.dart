...
class _QuicUIAppState extends State<QuicUIApp> {
  ...
  void initState() {
    super.initState();
    currentScreen = (widget.config['home'] as String?) ?? 'login';
  }

  void _navigateTo(String screenName, {Map<String, dynamic>? data}) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    // Inject navigation callback and data into screen config
    final enhancedConfig = Map<String, dynamic>.from(screenConfig);
    enhancedConfig['onNavigateTo'] = _navigateTo;

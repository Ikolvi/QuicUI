...
class MacosPatcher extends Patcher {
  ...
  String get _arm64AotOutputPath =>
      p.join(quicuiEnv.buildDirectory.path, 'out.arm64.aot');

  // The elf snapshot built for Intel macs.
  String get _x64AotOutputPath =>
      p.join(quicuiEnv.buildDirectory.path, 'out.x64.aot');
  ...
  Future<DiffStatus> assertUnpatchableDiffs({
    ...
    final podfileLockHash = quicuiEnv.macosPodfileLockHash;
...
For more information see: ${supportedFlutterVersionsUrl.toLink()}''');
    ...
    await artifactBuilder.buildElfAotSnapshot(
      ...
      genSnapshotArtifact: QuicuiArtifact.genSnapshotMacosArm64,
    );
    ...
    await artifactBuilder.buildElfAotSnapshot(
      ...
      genSnapshotArtifact: QuicuiArtifact.genSnapshotMacosX64,
    );
  ...
  Future<PatchArtifactBundle> _createPatchArtifactBundle({
    ...
    return PatchArtifactBundle(
      ...
      podfileLockHash: quicuiEnv.macosPodfileLockHash,
    );
  }

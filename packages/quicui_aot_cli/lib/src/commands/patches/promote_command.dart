...
/// {@endtemplate}
class PromoteCommand extends QuicuiCommand {
  ...
  Future<int> run() async {
    ...
    final appId = quicuiEnv.getQuicuiYaml()!.getAppId(flavor: flavor);
...
This is a bug and should never happen. Please file an issue at https://github.com/quicuitech/quicui/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title=fix%3A+''',
      );

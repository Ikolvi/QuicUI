...
class AarReleaser extends Releaser {
  ...
  Future<void> assertPreconditions() async {
    ...
    if (quicuiEnv.androidPackageName == null) {
  ...
  Future<FileSystemEntity> buildReleaseArtifacts() async {
    ...
    final sourceLibraryDirectory = Directory(
      QuicuiAndroidArtifacts.aarLibraryPath,
    );
  ...
  Future<void> uploadReleaseArtifacts({
    ...
    final extractedAarDir = await quicuiAndroidArtifacts.extractAar(
      packageName: quicuiEnv.androidPackageName!,
      buildNumber: buildNumber,
    ...
    await codePushClientWrapper.createAndroidArchiveReleaseArtifacts(
      ...
      aarPath: QuicuiAndroidArtifacts.aarArtifactPath(
        packageName: quicuiEnv.androidPackageName!,
        buildNumber: buildNumber,
      ),
...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        mavenCentral()
+       maven {
+           url '../${p.basename(quicuiEnv.getQuicuiProjectRoot()!.path)}/${p.relative(targetLibraryDirectory.path)}'
+       }
+       maven {

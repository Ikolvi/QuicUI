...
To change the version of this release, change your app's version in your pubspec.yaml.''',
    ...
    if (argResults.rest.contains('--obfuscate')) {
      ...
      logger
        ..err('Quicui does not currently support obfuscation on iOS.')
        ..info(
  ...
  Future<void> uploadReleaseArtifacts({
    ...
    if (quicuiEnv.iosPodfileLockFile.existsSync()) {
      podfileLockHash = sha256
          .convert(quicuiEnv.iosPodfileLockFile.readAsBytesSync())
          .toString();
    } else {
...
${styleBold.wrap('Make sure to uncheck "Manage Version and Build Number", or else quicui will not work.')}
''';
    }
  }
}

...
part of 'quicui_yaml.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

QuicuiYaml _$QuicuiYamlFromJson(Map json) => $checkedCreate(
  'QuicuiYaml',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$QuicuiYamlToJson(QuicuiYaml instance) =>
    <String, dynamic>{

...
/// The reference to the [QuicuiAndroidArtifacts] instance.
final quicuiAndroidArtifactsRef = create(QuicuiAndroidArtifacts.new);

/// The [QuicuiAndroidArtifacts] instance available in the current zone.
QuicuiAndroidArtifacts get quicuiAndroidArtifacts =>
    read(quicuiAndroidArtifactsRef);

/// Mixin on [QuicuiCommand] which exposes methods
// to find the artifacts generated for android
class QuicuiAndroidArtifacts {

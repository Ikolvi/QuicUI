...
/// {@template quicui_command}
/// A command in the Quicui CLI.
/// {@endtemplate}
abstract class QuicuiCommand extends Command<int> {
  // We don't currently have a test involving both a CommandRunner
  // and a Command, so we can't test this getter.
  // coverage:ignore-start
  @override
  QuicuiAotCliCommandRunner? get runner =>
      testRunner ?? super.runner as QuicuiAotCliCommandRunner?;
  // coverage:ignore-end
  ...
  @visibleForTesting
  QuicuiAotCliCommandRunner? testRunner;

  /// [ArgResults] for the current command.
  ArgResults get results => testArgResults ?? argResults!;
}

/// {@template quicui_proxy_command}
/// A command in the Quicui CLI that proxies to an underlying process.
/// {@endtemplate}
abstract class QuicuiProxyCommand extends QuicuiCommand {
  @override

...
/// permission, which is required for Quicui to work.
///
/// See https://github.com/quicuitech/quicui/issues/160.
...
The command you are running must be run within a Flutter app project that supports the Android platform. If you are releasing a Flutter module, use 'aar' in place of 'android' in your quicui command.''';
  // coverage:ignore-end

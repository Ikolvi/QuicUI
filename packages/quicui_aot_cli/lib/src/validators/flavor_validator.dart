...
/// Verifies that the flavors in the Quicui configuration match the
...
class FlavorValidator extends Validator {
  ...
  Future<List<ValidationIssue>> validate() async {
    ...
    final projectFlavors = quicuiYaml.flavors;
...
The default app id ${quicuiYaml.appId} will be used.''',
        ),
      ];
    }

The xcarchives in this folder were generated by building the stock Flutter counter app with `quicui release ios --no-codesign`. .dylib files have been removed to reduce size.

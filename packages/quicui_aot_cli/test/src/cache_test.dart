...
void main() {
  group(Cache, () {
    const quicuiEngineRevision = 'test-revision';
    ...
    group('clear', () {
      test('deletes the cache directory', () async {
        final quicuiCacheDirectory = runWithOverrides(
          () => Cache.quicuiCacheDirectory,
        )..createSync(recursive: true);
        expect(quicuiCacheDirectory.existsSync(), isTrue);
        await runWithOverrides(cache.clear);
        expect(quicuiCacheDirectory.existsSync(), isFalse);
      });
      ...
      group('patch', () {
        ...
        test('pulls correct artifact for MacOS', () async {
          ...
          String perEngine(String name) =>
              '${cache.storageBaseUrl}/${cache.storageBucket}/quicui/$quicuiEngineRevision/$name';

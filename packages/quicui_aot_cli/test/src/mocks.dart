...
import 'package:quicui_aot_cli/src/archive_analysis/archive_analysis.dart';
import 'package:quicui_aot_cli/src/archive_analysis/archive_differ.dart';
...
import 'package:quicui_aot_cli/src/cache.dart' show Cache;
...
class MockProcessResult extends Mock implements QuicuiProcessResult {}
...
class MockQuicuiAndroidArtifacts extends Mock
    implements QuicuiAndroidArtifacts {}

class MockQuicuiArtifacts extends Mock implements QuicuiArtifacts {}

class MockQuicuiAotCliCommandRunner extends Mock
    implements QuicuiAotCliCommandRunner {}

class MockQuicuiEnv extends Mock implements QuicuiEnv {}

class MockQuicuiFlutter extends Mock implements QuicuiFlutter {}

class MockQuicuiLogger extends Mock implements QuicuiLogger {}

class MockQuicuiProcess extends Mock implements QuicuiProcess {}

class MockQuicuiProcessResult extends Mock
    implements QuicuiProcessResult {}

class MockQuicuiValidator extends Mock implements QuicuiValidator {}

class MockQuicuiVersion extends Mock implements QuicuiVersion {}

class MockQuicuiYaml extends Mock implements QuicuiYaml {}

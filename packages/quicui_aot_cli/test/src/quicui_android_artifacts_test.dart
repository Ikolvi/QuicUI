...
void main() {
  group(QuicuiAndroidArtifacts, () {
    ...
    setUp(() {
      ...
      quicuiAndroidArtifacts = QuicuiAndroidArtifacts();
    });
    ...
    group('aarLibraryPath', () {
      test('returns path to AAR library', () {
        expect(
          runWithOverrides(() => QuicuiAndroidArtifacts.aarLibraryPath),
    ...
    group('aarArtifactDirectory', () {
      test('returns path to AAR artifact directory', () {
        expect(
          runWithOverrides(
            () => QuicuiAndroidArtifacts.aarArtifactDirectory(
              buildNumber: '1',
    ...
    group('aarArtifactPath', () {
      test('returns path to AAR artifact', () {
        final result = runWithOverrides(
          () => QuicuiAndroidArtifacts.aarArtifactPath(
            packageName: 'com.example',
            buildNumber: '1',
          ),
        );

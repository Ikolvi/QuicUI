...
import 'package:quicui_aot_code_push_client/src/version.dart';
...
/// Dart client for the Quicui CodePush API.
/// {@endtemplate}
class CodePushClient {
  ...
  CodePushClient({
    ...
    Map<String, String>? customHeaders,
       ...
       hostedUri = hostedUri ?? Uri.https('api.quicui.dev');
  ...
  /// The hosted uri for the Quicui CodePush API.
  final Uri hostedUri;
  ...
  /// Create a new Quicui user with the provided [name].
  ///

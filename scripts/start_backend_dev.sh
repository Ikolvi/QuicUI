...
# QuicUI Code Push - Backend Server (Development Mode)
# Starts the backend server with local dev configuration
...
echo "╔════════════════════════════════════════════════════════╗"
echo "║                                                        ║"
echo "║     QuicUI Code Push - Backend Server (Dev Mode)     ║"
echo "║                                                        ║"
...
log_step "Step 2: Configure Development Environment"
export SERVER_HOST="$BACKEND_HOST"
export SERVER_PORT="$BACKEND_PORT"
export QUICUI_ENVIRONMENT="development"
export QUICUI_ALLOWED_ORIGINS="http://localhost:8080,http://localhost:3000,http://localhost:3001,http://192.168.20.100:8080"

log_info "Environment configured:"
echo "  SERVER_HOST: $SERVER_HOST"
echo "  SERVER_PORT: $SERVER_PORT"
echo "  QUICUI_ENVIRONMENT: development"
echo "  QUICUI_ALLOWED_ORIGINS: $QUICUI_ALLOWED_ORIGINS"

# Start server
log_step "Step 3: Start Backend Server"
echo ""
